...
class Numbers_Roman
{
    ...
    public static function toNumber($roman)
    {
        ...
        while ($len >= 0) {
             ...
             */
            if ($pos === false) {
                throw new Exception('Numbers_Roman::toNumber error: Invalid characters in input');
            } else {
                ...
                */
                if ($state > $conv[$pos]) {
                    if (!$state2){
                        ...
                        throw new Exception('Numbers_Roman::toNumber error: Invalid numeral order in input (multiple subtraction)');
                    }
     ...
     * @access private
     */
    public static function toRoman($num, $uppercase = true)
    {
     ...
     * @access public
     */
    public static function toNumeral($num, $uppercase = true, $html = true)
    {
