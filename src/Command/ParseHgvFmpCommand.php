...
class ParseHgvFmpCommand extends Command
{
    ...
    protected static $defaultName = 'app:parse-hgv-fmp';

    function __construct(){
        $this->loadFmpData(self::IMPORT_DIR . '/' . $this->importFile);
        parent::__construct();
    }
...
echo $key . ' > ' . $position . "\n";
    ...
    protected function loadFmpData($fmpFile){
      // xpath
      $doc = new DOMDocument();
      $doc->load($fmpFile);
